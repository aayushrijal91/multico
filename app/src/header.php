	...
	<header>
		<div class="header-inner">
					...
					<div class="row justify-content-center justify-content-lg-between align-items-center">
						...
						<div class="col-12 col-lg-auto pt-4 pt-lg-0">
							<div class="row justify-content-center justify-content-lg-end no-gutters align-items-center">
								...
								<div class="col-6 col-lg-auto pl-2 pl-xl-4">
									<a href="tel:<?= $phone_number ?>" class="btn btn-block btn-primary text-black py-3 py-xl-4 px-md-5 fw-900 h8">
										<?= $phone_number ?>
									</a>
								</div>
							</div>
			...
			<div class="banner">
				<div class="container">
					<div class="row">
						<div class="col-12 col-lg-11 col-xl-7 col-xxl-6">
